...
import { Eye, TrendingUp, CalendarDays, ArrowLeft, BarChart2, Clock } from 'lucide-react'
...
interface PostDailyView   { date: string;  views: number }
interface PostMonthlyView { month: string; views: number }
interface PostYearlyView  { year: string;  views: number }
...
function ViewsChart({ stats, period }: { stats: PostStatsView; period: Period }) {
    const data =
        period === 'daily'
                ...
                <div className="mx-auto max-w-5xl space-y-8 px-4 py-10">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                            <div>
                                <h1 className="text-2xl font-bold tracking-tight mb-2">{blog.title}</h1>
                                {generatedAt && (
                        ...
                        <>
                            ...
                            <div className="grid gap-4 sm:grid-cols-3">
                                ...
                                <StatCard
                                    icon={CalendarDays}
                                    label="Peak Month"
                                    value={formatNumber(peakViews(stats.monthly))}
